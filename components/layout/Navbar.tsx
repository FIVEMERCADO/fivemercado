      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            {/* Credits */}
            <Link href="/credits" className="flex items-center gap-1.5 px-3 py-1.5 bg-yellow-500/10 border border-yellow-500/20 rounded-lg hover:bg-yellow-500/20 transition-colors">
              ...
              {userOpen && (
                <div className="absolute right-0 mt-2 w-48 bg-dark-lighter border border-white/10 rounded-xl shadow-xl overflow-hidden">
                  <div className="px-4 py-3 border-b border-white/5">
                    <p className="text-xs font-inter text-gray-400">Conectado como</p>
                  ...
                  <div className="py-1">
                    ...
                    <Link href="/upload" className="block px-4 py-2 text-sm text-gray-400 hover:text-white hover:bg-white/5 transition-colors">
                      Vender Scripts
                    </Link>
                    <Link href="/credits" className="block px-4 py-2 text-sm text-gray-400 hover:text-white hover:bg-white/5 transition-colors">
                      Comprar Créditos
                    </Link>
        ...
        <div className="md:hidden border-t border-white/5 bg-dark/95 backdrop-blur-xl">
          <div className="px-4 py-4 space-y-1">
            ...
            <div className="pt-3 border-t border-white/5 flex items-center gap-3">
              <Link href="/credits" className="flex items-center gap-1.5 px-3 py-1.5 bg-yellow-500/10 border border-yellow-500/20 rounded-lg">
                <span className="text-sm">🪙</span>
                <span className="text-xs font-rajdhani font-bold text-yellow-400">1,250</span>
              </Link>
              <Link
