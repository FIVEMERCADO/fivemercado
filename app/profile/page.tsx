            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-4">
                <div className="text-center">
                  ...
                  <p className="text-xs text-gray-500 font-inter">4.7/5 · 12 reviews</p>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-dark-lighter/70 border border-white/5 rounded-2xl p-6 space-y-4">
              ...
              <div className="space-y-3">
                {[
                  { icon: <Shield className="w-4 h-4 text-emerald-400" />, label: "Status", value: "Active" },
                  { icon: <Calendar className="w-4 h-4 text-gray-500" />, label: "Member since", value: "Jan 15, 2024" },
                  { icon: <Coins className="w-4 h-4 text-yellow-400" />, label: "Credits", value: "1,250 🪙" },
                ].map((item) => (
            ...
            <div className="bg-dark-lighter/70 border border-white/5 rounded-2xl p-6">
              ...
              <div className="flex items-center gap-3 p-3 bg-indigo-900/20 border border-indigo-500/20 rounded-xl mb-3">
                ...
                <div>
                  <p className="text-xs text-gray-500 font-inter">Linked to:</p>
              ...
              <p className="text-xs text-gray-600 font-inter mb-3">
                Required to receive download codes via the Discord bot.
              </p>
            ...
            <div className="bg-dark-lighter/70 border border-white/5 rounded-2xl p-6 space-y-4">
              ...
              <div>
                <label className="text-xs text-gray-500 uppercase tracking-wider font-inter">Username</label>
                <input
                  value={username}
                ...
                />
                <p className="text-xs text-gray-600 font-inter mt-1">{username.length}/30 chars</p>
              </div>
              <div>
                <label className="text-xs text-gray-500 uppercase tracking-wider font-inter">Bio</label>
                <textarea
                  value={bio}
                ...
                />
                <p className="text-xs text-gray-600 font-inter mt-1">{bio.length}/500 chars</p>
              </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {codeSent && (
              <div className="bg-primary/10 border border-primary/20 text-primary p-4 rounded-2xl text-sm font-bold flex items-start gap-3">
                ...
                <div>
                  Your one-time download code is:{" "}
                  ...
                  <span className="text-xs text-primary/70 font-inter font-normal">
                    ...
                    <code className="bg-primary/10 px-1 rounded">/redeem {codeSent}</code> to get your download link.
                  </span>
                </div>
              </div>
            )}
            ...
            <div className="flex gap-1 border-b border-white/10">
              {(["purchased", "scripts"] as const).map((tab) => (
                ...
                >
                  {tab === "purchased" ? `PURCHASED SCRIPTS (${MOCK_PURCHASED.length})` : "MY SCRIPTS (0)"}
                </button>
              ))}
            </div>
            ...
            {activeTab === "purchased" ? (
              ...
              <div className="text-center py-16">
                ...
                <p className="text-gray-500 font-inter text-sm mb-6">
                  Upload your first FiveM script and start earning credits.
                </p>
                <Link
                  href="/upload"
